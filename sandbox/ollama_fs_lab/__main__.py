...
Avvia il loop MockSTT/TTS + Ollama con tool `create_text_file` (Step 2).
"""
...
def main() -> None:
    ...
    try:
        ...
        # Banner: modello, URL e dove finiscono i .txt creati.
        print(
            f"[lab] modello={OLLAMA_MODEL} url={OLLAMA_URL} "
            f"workspace={root} tool=create_text_file",
            file=sys.stderr,
        )
